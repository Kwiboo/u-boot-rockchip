...
#define ROCKCHIP_SOC_RK3538	(ROCKCHIP_CPU_RK3538 | 0x00)
#define ROCKCHIP_SOC_RK3539	(ROCKCHIP_CPU_RK3539 | 0x00)
...
#elif defined(CONFIG_ROCKCHIP_RK3538)
	if (of_machine_is_compatible("rockchip,rk3539"))
		return ROCKCHIP_SOC_RK3539;
	else
		return ROCKCHIP_SOC_RK3538;
...
ROCKCHIP_SOC(rk3538, RK3538)
ROCKCHIP_SOC(rk3539, RK3539)
