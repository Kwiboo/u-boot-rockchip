...
{
#ifdef CONFIG_SPL_BUILD
	struct rk3399_pmusgrf_regs * const sgrf = (void *)RK3399_PMUSGRF_BASE;
	struct rk3399_grf_regs * const grf = (void *)RK3399_GRF_BASE;
...
void spl_board_init(void)
{
	...
	if (IS_ENABLED(CONFIG_SPL_GPIO)) {
		struct rockchip_cru *cru = (void *)RK3399_CRU_BASE;
